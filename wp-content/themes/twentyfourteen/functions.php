...
function twentyfourteen_get_featured_posts() {
	 ...
	 *        	Array of featured posts, otherwise false.
	 */
...
function twentyfourteen_scripts() {
	...
	wp_enqueue_style ( 'twentyfourteen-ie', get_template_directory_uri () . '/css/ie.css', array (
	...
	if (is_singular () && wp_attachment_is_image ()) {
		wp_enqueue_script ( 'twentyfourteen-keyboard-image-navigation', get_template_directory_uri () . '/js/keyboard-image-navigation.js', array (
				'jquery' 
		), '20130402' );
	}
	...
	if (is_front_page () && 'slider' == get_theme_mod ( 'featured_content_layout' )) {
		wp_enqueue_script ( 'twentyfourteen-slider', get_template_directory_uri () . '/js/slider.js', array (
				'jquery' 
		), '20131205', true );
	...
	wp_enqueue_script ( 'twentyfourteen-script', get_template_directory_uri () . '/js/functions.js', array (
			'jquery' 
	), '20150315', true );
}
...
if (! function_exists ( 'twentyfourteen_the_attached_image' )) :
	...
	function twentyfourteen_the_attached_image() {
		 ...
		 *        	}
		 */
		$attachment_size = apply_filters ( 'twentyfourteen_attachment_size', array (
				810,
				810 
		) );
 ...
 *       
 * @param array $classes
 *        	A list of existing post class values.
