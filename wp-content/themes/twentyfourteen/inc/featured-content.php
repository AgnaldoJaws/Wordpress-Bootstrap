...
class Featured_Content {
	...
	public static function init() {
		...
		add_action ( 'delete_post_tag', array (
				__CLASS__,
				'delete_post_tag' 
		) );
	...
	public static function wp_loaded() {
		if (self::get_setting ( 'hide-tag' )) {
			...
			add_filter ( 'get_the_terms', array (
					__CLASS__,
	 ...
	 *       
	 * @param array $terms
	 *        	List of term objects. This is the return value of get_terms().
	...
	public static function register_setting() {
		register_setting ( 'featured-content', 'featured-content', array (
				__CLASS__,
				'validate_settings' 
		) );
	}
