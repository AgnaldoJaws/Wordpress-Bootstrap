...
.akismet_activate {
	...
	margin: 15px 0;
	background: #83AF24;
	background-image: -webkit-gradient(linear, 0% 0, 80% 100%, from(#83AF24),
		to(#4F800D));
...
.akismet_activate .aa_button {
	...
	color: #FFF;
	background: #029DD6;
	background-image: -webkit-gradient(linear, 0% 0, 0% 100%, from(#029DD6),
		to(#0079B1));
...
.akismet_activate .aa_button:hover {
	...
	color: #F0F8FB;
	background: #0079B1;
	background-image: -webkit-gradient(linear, 0% 0, 0% 100%, from(#0079B1),
		to(#0092BF));
	...
	<form name="akismet_activate"
		...
		<div class="akismet_activate">
			...
			<div class="aa_button_container"
				onclick="document.akismet_activate.submit();">
